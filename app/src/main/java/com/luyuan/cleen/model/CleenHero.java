package com.luyuan.cleen.model;
...
public class CleenHero {
    ...
    public static List<CleenHero> arrayCleenHeroFromData(String str) {

        Type listType = new TypeToken<ArrayList<CleenHero>>() {}.getType();
    ...
    public static class RowsBean {
        ...
        public static List<RowsBean> arrayRowsBeanFromData(String str) {
            ...
            Type listType = new TypeToken<ArrayList<RowsBean>>() {
            }.getType();
